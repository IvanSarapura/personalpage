Proven — the dispute-resolution protocol my team started at GenLayer's Bradbury Builders Hackathon — rests on an unusual primitive: smart contracts that ask LLMs to evaluate evidence. Here's what building on non-deterministic oracles actually feels like.
